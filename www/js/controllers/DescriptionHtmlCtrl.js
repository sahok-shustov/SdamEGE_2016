ege.controller('DescriptionHtmlCtrl', ['$scope', '$rootScope', '$stateParams', '$sce', '$timeout',
    function($scope, $rootScope, $stateParams, $sce, $timeout) {
        ...
        // if (!$scope.materialsList) {
            ...
            $scope.link = { src: 'https://unitest.tv/api/get_html_material/' + $stateParams.material_html_ID };
